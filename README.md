This project on terraform shows a deployed VPC in us-east-1 containing a NGINX server. An IGW, Route table, and public subnets were configured to allow ingress traffic
